...
def generate_launch_description():
    ...
    rviz_and_imu_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([wit_ros2_imu,'/launch','/rviz_and_imu.launch.py']),
    )
    ...
    return LaunchDescription([lslidar_driver_node,rviz_and_imu_node,robot_state_publisher_node,nav2_bringup_launch,rviz_node])
